...
Original file is located at
    https://colab.research.google.com/drive/1Ag5UPSgkI62JbbpJGatTaXXLHHxLL0Wb
"""
...
# Colab
df = pd.read_csv('/content/drive/MyDrive/Titanic_assignment_data_24.csv')
df
...
opt=SGD(learning_rate=0.025,momentum=0.7)
...
# Important
x_training,x_validation,y_training,y_validation=train_test_split(x_train,y_train,test_size=0.2,random_state=4)
...
# Colab
model.save('/content/drive/MyDrive/titanic_ANN_trained_model.h6')
...
# Colab
ANN_model=keras.models.load_model('/content/drive/MyDrive/titanic_ANN_trained_model.h6')
